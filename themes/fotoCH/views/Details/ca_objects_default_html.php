...
?>
        ...
        {{{<ifdef code="ca_objects.representation"><H6>Medium / Format:</H6>^ca_objects.representation<br/></ifdef>}}}
				...
				<hr></hr>
					<div class="row">
						<div class="col-sm-12">
							...
							{{{<ifcount code="ca_entities" min="2"><H6>Related people and organizations</H6></ifcount>}}}
